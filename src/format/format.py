...
from constant.format import INTERRUPT_PIN, FORMAT_DATA_SIZE_MIN, FORMAT_ADRS, FORMAT_CMD, FORMAT_DATA_SIZE, FORMAT_DATA_START  ,BUFFER_SIZE_COM, INIT_ADDR, BUFFER_SIZE_MC, BUFFER_SIZE_EPS, CAM_ADDR, DATA_OVERFLOW, DATA_CRC_ERROR, DATA_ADRS_ERROR, DATA_CORRECT
...
MC_line = serial.Serial('/dev/ttyAMA0',9600,timeout=0.5)
